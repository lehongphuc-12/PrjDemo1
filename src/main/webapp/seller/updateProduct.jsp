            ...
            <form action="addProduct" method="POST" enctype="multipart/form-data">
                <div class="left-column">
                    <div class="form-group">
                        ...
                        <input type="text" id="productName" name="productName" maxlength="100" required value="${product.productName}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="quantity" name="quantity" step="1" min="0" required value="${product.quantity}">
                    </div>
                </div>
                <div class="right-column">
                    <div class="form-group">
                        ...
                        <select id="productGroupId" name="productGroupId" required>
                            <option value="${product.categoryID.groupID.groupID}">${product.categoryID.groupID.groupName}</option>
                    ...
                    <div class="form-group">
                        ...
                        <select id="cityId" name="cityId" required>
                            <option value="${product.cityID.cityID}">${product.cityID.cityName}</option>
                ...
                <button type="button" class="submit-btn" onclick="updateProduct(${product.productID})">
